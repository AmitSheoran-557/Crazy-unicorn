            ...
            <div className='flex max-w-[1320px] mx-auto justify-between gap-3 max-xl:flex-wrap max-xl:justify-center max-xl:gap-y-12 mt-[154px] max-lg:mt-20 max-md:mt-12 max-sm:mt-8 items-end'>
                {TEAM_CARDS.map((obj, i) => (
                    <div className='bg-off-white border w-[424px] max-sm:w-[340px] border-pink-500 rounded-3xl group pb-5 text-center' key={i}>
                        <img className='pointer-events-none max-w-[312px] mx-auto -mt-9 group-hover:max-w-[381px] max-sm:max-w-[250px] max-sm:group-hover:max-w-[340px] group-hover:-mt-[74px] transition-all ease-in-out duration-300' src={Horse} alt="horse" />
